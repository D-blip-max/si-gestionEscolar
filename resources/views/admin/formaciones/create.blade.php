                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control" name="nivel" id="nivel" required>
                                                    ...
                                                    <option value="Técnico"
                                                        {{ old('nivel') == 'Técnico' ? 'selected' : '' }}>Técnico</option>
                                                    <option value="Licenciatura"
                                                        {{ old('nivel') == 'Licenciatura' ? 'selected' : '' }}>Licenciatura
                                                    </option>
                                                    <option value="Maestría"
                                                        {{ old('nivel') == 'Maestría' ? 'selected' : '' }}>Maestría</option>
                                                    <option value="Doctorado"
                                                        {{ old('nivel') == 'Doctorado' ? 'selected' : '' }}>Doctorado
                                                    </option>
                                                </select>
                                            </div>
                                            @error('nivel')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date" class="form-control" name="fecha_graduacion"
                                                    id="fecha_graduacion" value="{{ old('fecha_graduacion') }}" required>
                                            </div>
