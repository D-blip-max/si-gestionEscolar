                ...
                <div class="card-body">
                    <form action="{{ url('/admin/ppffs/'.$ppff->id) }}" method="POST">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('nombres',$ppff->nombres) }}"
                                            name="nombres" placeholder="Ingrese los nombres..." required>
                                    </div>
                                    @error('nombres')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Cédula de Identidad</label><b> (*)</b>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                        </div>
                                        <input type="text" class="form-control" value="{{ old('ci',$ppff->ci) }}"
                                            name="ci" placeholder="Ingrese el número de CI..." required>
                                    </div>
                                    @error('ci')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('telefono',$ppff->telefono) }}"
                                            name="telefono" placeholder="Ingrese el número telefónico..." required>
                                    </div>
                                    @error('telefono')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('parentesco',$ppff->parentesco) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('ocupacion',$ppff->ocupacion) }}"
                                            name="ocupacion" placeholder="Ingrese la ocupación..." required>
                                    </div>
                                    @error('ocupacion')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('direccion',$ppff->direccion) }}"
                                            name="direccion" placeholder="Ingrese la dirección..." required>
                                    </div>
                                    @error('direccion')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
